...
function processLogo(img){
  ...
  if(trans<=w*h*0.02){
    // EDGE FLOOD-FILL knockout: remove only background connected to the border, within tolerance of
    // the border colour. Preserves white/light areas INSIDE the mark and survives non-uniform bg.
